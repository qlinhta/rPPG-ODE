...
class Preprocess:
    """
    Implements preprocessing, including: face detection, normalization, etc.
    Ultimately saves as npy
    Processes UBFC_rPPG database - dataset_2
    """
    ...
    def read_process(self):
        ...
        for i in progress_bar:
            ...
            frames = self.read_video(data_path)
            gts = self.read_wave(data_path)
